  ...
  return (
    <div className="w-full">
       ...
       <div className="flex flex-col shadow-lg ring-1 ring-accent/10 bg-primary-two/40 rounded-xl relative z-40 backdrop-blur-sm justify-between px-4 py-6 w-full max-w-[600px] mx-auto">
        <h1 className="text-copy-primary font-sans font-bold text-3xl/10 tracking-tight md:text-6xl p-6y relative mb-16 text-left text-transparent bg-clip-text bg-gradient-to-r from-copy-primary to-accent line">BrightNotes</h1>
